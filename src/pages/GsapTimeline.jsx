...
const GsapTimeline = () => {
  ...
  useGSAP(() => {
    timeline
      .to("#yellow-box", { x: 250, rotation: 360, borderRadius: '100%', duration: 1, ease: "back.inOut" })

    timeline.to("#yellow-box", { x: 500, scale:2, rotation: 360, borderRadius: '100%', duration: 2, ease: "back.inOut" });
